            ...
            <div className="col-12">
                <div className="card">
                    ...
                    >
                        ...
                        <Column field="firstName" header="firstName" sortable body={nameBodyTemplate} headerStyle={{ minWidth: '15rem' }}></Column>
                        <Column header="Image" body={imageBodyTemplate}></Column>
                        <Column field="email" header="Email" body={priceBodyTemplate} sortable></Column>
                        <Column field="mobile" header="Mobile" sortable body={categoryBodyTemplate} headerStyle={{ minWidth: '10rem' }}></Column>
                        <Column field="position" header="Position" body={ratingBodyTemplate} sortable></Column>
